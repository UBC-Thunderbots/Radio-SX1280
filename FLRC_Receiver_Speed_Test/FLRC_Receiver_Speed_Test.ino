...
void setup()
{
  ...
  LT.setPacketParams(PREAMBLE_LENGTH_08_BITS, FLRC_SYNC_WORD_LEN_P32S, RADIO_RX_MATCH_SYNCWORD_1, RADIO_PACKET_FIXED_LENGTH, RXBUFFER_SIZE, RADIO_CRC_OFF, RADIO_WHITENING_OFF);
