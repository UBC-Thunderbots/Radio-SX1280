...
class SX1280:
    ...
    def __init__(self, spi, cs, reset, busy, frequency, *, preamble_length=8, baudrate=100000, debug=False, txen=False, rxen=False):
    ...
    def _send_command(self,command,stat=True):
        _size=len(command)
        self._busywait()
        ...
        self._busywait()
        print(f"end of _send_command(): {self._busy.value}")
